  ...
  <div className="flex justify-center flex-col items-center"> 
    ...
    {formData.images && formData.images.length > 0 && (
      ...
      >
        ...
        <input type="text" placeholder="Zahle" id="address"  onChange={handleInputChange}  className="input border-green-500 input-bordered w-full max-w-xs mb-2"  /> 
          <div className="label  flex justify-between"> 
            
            <span className="label-text-alt text-sm text-gray-500"></span>
            <span className="label-text-alt text-gray-600 text-sm flex"> Why is it important?
