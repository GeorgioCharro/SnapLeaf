...
function DiagnoseResult() {
    ...
    const handleOpenModal = (content) => {setModalContent(content); setModalOpen(true)}
    const handleCloseModal = () => {setModalContent(null); setModalOpen(false)}
      ...
      <div className='flex flex-col gap-4'>
        <div className='flex flex-col items-start justify-between p-4 '>
          <div className='flex items-center pb-4'>
            ...
            <button onClick={() => setModalContent(<><div className='flex items-center'>
        ...
        {diagnose.Second_Suggested_Disease_Name && (
          <div className='flex flex-col items-start justify-between  p-4 '>
            <div className='flex items-center pb-4'>
              ...
              <img src={InformationCircle} className='h-5 w-5 ml-3' alt="Visibility Icon" />
              <button onClick={() => handleOpenModal(<><div className='flex items-center'>
                <InfoIcon style={{color:'#10B981'}} />
                <p className='text-gray-700 font-bold text-xl ml-2'>Disease Description</p>
